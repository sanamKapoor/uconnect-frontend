            ...
            <div className="shadow p-2">
                {
                    ...
                    <div className="all-posts-img">
                        <video src={post.mediaFile.filePath} controls controlsList="nodownload" autoPlay muted loop style={{height: '100%', width: '100%', display: 'flex'}}></video>
                    </div>
                    : 
                    <ShowImage src={post.mediaFile.filePath} classes="all-posts-img" />
                }
                {
                    isAdmin &&
